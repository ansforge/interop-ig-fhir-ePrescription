# FRMedicationStatementReconciliationProperties - Guide d'implémentation de la ePrescription v0.1.0
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fhir.fr.eprescription|current/StructureDefinition/fr-medicationstatement-reconciliation-properties)
