# value set Interop'Santé - qualification de la divergence identifiée sur une ligne de traitement d'une FCT - Guide d'implémentation de la ePrescription v0.1.0
