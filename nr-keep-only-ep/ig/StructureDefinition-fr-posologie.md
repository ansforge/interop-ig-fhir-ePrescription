# Posologie - Guide d'implémentation de la ePrescription v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:https://hl7.fr/ig/fhir/eprescription/StructureDefinition/fr-posologie | *Version*:0.1.0 |
| Draft as of 2025-10-28 | *Computable Name*:Posologie |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fhir.fr.eprescription|current/StructureDefinition/fr-posologie)
...
```json
{
  ...
  "id" : "fr-posologie",
  "url" : "https://hl7.fr/ig/fhir/eprescription/StructureDefinition/fr-posologie",
  "version" : "0.1.0",
  "name" : "Posologie",
  "title" : "Posologie",
  "status" : "draft",
  ...
  "kind" : "logical",
  "abstract" : false,
  "type" : "https://hl7.fr/ig/fhir/eprescription/StructureDefinition/fr-posologie",
