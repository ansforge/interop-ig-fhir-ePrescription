# Presc-MiniperfCefotaxime-En20min-Pdt3j - Guide d'implémentation de la ePrescription v0.1.0
...
> **dosageInstruction****timing**: Une fois par 6 hours**route**:Voie intraveineuse
...
| :--- | :--- | :--- |
| - | **Extension** | **Rate[x]** |
| * |  | 4 g(Détails : code UCUMg = 'g')/20 min(Détails : code UCUMmin = 'min') |
