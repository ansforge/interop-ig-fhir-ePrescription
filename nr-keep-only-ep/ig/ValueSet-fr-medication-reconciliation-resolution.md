# value set Interop'Santé - Résolution d'une divergence sur une ligne de traitement d'une FCT - Guide d'implémentation de la ePrescription v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:https://hl7.fr/ig/fhir/eprescription/ValueSet/fr-medication-reconciliation-resolution | *Version*:0.1.0 |
...
* Include tous les codes définis dans [`https://hl7.fr/ig/fhir/eprescription/CodeSystem/fr-medication-reconciliation-resolution`](CodeSystem-fr-medication-reconciliation-resolution.md)version 📦0.1.0
...
```json
{
  ...
  "url" : "https://hl7.fr/ig/fhir/eprescription/ValueSet/fr-medication-reconciliation-resolution",
  "version" : "0.1.0",
  ...
  "compose" : {
    "include" : [
      {
        "system" : "https://hl7.fr/ig/fhir/eprescription/CodeSystem/fr-medication-reconciliation-resolution"
      }
    ]
  }
}
