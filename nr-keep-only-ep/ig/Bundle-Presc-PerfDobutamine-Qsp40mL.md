# Presc-PerfDobutamine-Qsp40mL - Guide d'implémentation de la ePrescription v0.1.0
...
> **dosageInstruction****sequence**: 1**timing**: Durée 1?? , Une fois**route**:Voie intraveineuse
...
| :--- | :--- | :--- |
| - | **Extension** | **Rate[x]** |
| * |  | 400 µg(Détails : code UCUMug = 'ug')/1 min(Détails : code UCUMmin = 'min') |
