...
| | |
| :--- | :--- |
| *Official URL*:https://hl7.fr/ig/fhir/eprescription/ValueSet/fr-medication-history-source-type | *Version*:0.1.0 |
...
* Include tous les codes définis dans [`https://hl7.fr/ig/fhir/eprescription/CodeSystem/fr-medication-history-source-type`](CodeSystem-fr-medication-history-source-type.md)version 📦0.1.0
...
```json
{
  ...
  "url" : "https://hl7.fr/ig/fhir/eprescription/ValueSet/fr-medication-history-source-type",
  "version" : "0.1.0",
  ...
  "compose" : {
    "include" : [
      {
        "system" : "https://hl7.fr/ig/fhir/eprescription/CodeSystem/fr-medication-history-source-type"
      }
    ]
  }
}
