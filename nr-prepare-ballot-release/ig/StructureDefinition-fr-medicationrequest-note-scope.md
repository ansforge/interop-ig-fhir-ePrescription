# Scope for note element in MedicationRequest - Guide d'implémentation de la ePrescription v0.1.0-ballot
...
| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/fhir/eprescription/StructureDefinition/fr-medicationrequest-note-scope | *Version*:0.1.0-ballot |
