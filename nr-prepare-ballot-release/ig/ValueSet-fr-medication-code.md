# value set Interop'Santé - Codes identifiant les médicaments - Guide d'implémentation de la ePrescription v0.1.0-ballot
...
| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/fhir/eprescription/ValueSet/fr-medication-code | *Version*:0.1.0-ballot |
| Draft as of 2026-05-06 | *Computable Name*:FRMedicationCodes |
