# Posologie - Guide d'implémentation de la ePrescription v1.1.0-ballot

## Modèle logique: Posologie 
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-posologie.csv), [Excel](../StructureDefinition-fr-posologie.xlsx) 
