...
## Profil de ressource: FR Medication Compound 
...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fhir.fr.eprescription|current/StructureDefinition/fr-medication-compound)
...
* [https://interop.esante.gouv.fr/ig/fhir/eprescription/StructureDefinition/fr-is-vehicle](StructureDefinition-fr-is-vehicle.md)
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-medication-compound.csv), [Excel](../StructureDefinition-fr-medication-compound.xlsx), [Schematron](../StructureDefinition-fr-medication-compound.sch) 
