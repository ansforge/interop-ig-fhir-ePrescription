# FR Medication Request - Guide d'implémentation de la ePrescription v1.1.0-ballot

## Profil de ressource: FR Medication Request 
...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fhir.fr.eprescription|current/StructureDefinition/fr-medicationrequest)
...
* [FR Medication Non Compound (https://interop.esante.gouv.fr/ig/fhir/eprescription/StructureDefinition/fr-medication-noncompound)](StructureDefinition-fr-medication-noncompound.md)
* [FR Medication Compound (https://interop.esante.gouv.fr/ig/fhir/eprescription/StructureDefinition/fr-medication-compound)](StructureDefinition-fr-medication-compound.md)
...
* [FR Core Encounter Profile (https://hl7.fr/ig/fhir/core/StructureDefinition/fr-core-encounter)](https://hl7.fr/ig/fhir/core/2.1.0/StructureDefinition-fr-core-encounter.html)
* [FR Core Practitioner Profile (https://hl7.fr/ig/fhir/core/StructureDefinition/fr-core-practitioner)](https://hl7.fr/ig/fhir/core/2.1.0/StructureDefinition-fr-core-practitioner.html)
* [Range with UCUM or EDQM codes if code is used (https://interop.esante.gouv.fr/ig/fhir/eprescription/StructureDefinition/FrRangeMedication)](StructureDefinition-FrRangeMedication.md)
...
* [Ratio with UCUM or EDQM codes if code is used (https://interop.esante.gouv.fr/ig/fhir/eprescription/StructureDefinition/FrRatioMedication)](StructureDefinition-FrRatioMedication.md)

**Extensions**

Cette structure fait référence à ces extensions:

* [http://hl7.org/fhir/5.0/StructureDefinition/extension-MedicationRequest.renderedDosageInstruction](http://hl7.org/fhir/uv/xver-r5.r4/0.1.0/StructureDefinition-ext-R5-MedicationRequest.renderedDosageInstruction.html)
* [https://interop.esante.gouv.fr/ig/fhir/eprescription/StructureDefinition/fr-treatment-intent](StructureDefinition-fr-treatment-intent.md)
* [https://interop.esante.gouv.fr/ig/fhir/eprescription/StructureDefinition/fr-additional-when-values](StructureDefinition-fr-additional-when-values.md)
* [https://interop.esante.gouv.fr/ig/fhir/eprescription/StructureDefinition/fr-basis-of-dose-component](StructureDefinition-fr-basis-of-dose-component.md)
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-medicationrequest.csv), [Excel](../StructureDefinition-fr-medicationrequest.xlsx), [Schematron](../StructureDefinition-fr-medicationrequest.sch) 
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/eprescription/StructureDefinition/fr-treatment-intent"]
      }],
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/eprescription/StructureDefinition/fr-additional-when-values"]
      }]
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/eprescription/StructureDefinition/fr-basis-of-dose-component"]
      }]
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Range",
        "profile" : ["https://interop.esante.gouv.fr/ig/fhir/eprescription/StructureDefinition/FrRangeMedication"]
      }]
    },
    {
