...
## Profil de ressource: FR Prescription Bundle For Example 
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-prescription-bundle-for-example.csv), [Excel](../StructureDefinition-fr-prescription-bundle-for-example.xlsx), [Schematron](../StructureDefinition-fr-prescription-bundle-for-example.sch) 
