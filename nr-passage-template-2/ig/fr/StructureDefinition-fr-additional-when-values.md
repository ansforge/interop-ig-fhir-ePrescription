# Additional values for when element - Guide d'implémentation de la ePrescription v1.1.0-ballot
...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fhir.fr.eprescription|current/StructureDefinition/fr-additional-when-values)
...
Extension simple avec le type code : Additional values for Timing.repeat.when
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-additional-when-values.csv), [Excel](../StructureDefinition-fr-additional-when-values.xlsx), [Schematron](../StructureDefinition-fr-additional-when-values.sch) 
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "required",
        "valueSet" : "https://interop.esante.gouv.fr/ig/fhir/eprescription/ValueSet/fr-additional-when-codes-vs"
      }
    }]
  }
}
