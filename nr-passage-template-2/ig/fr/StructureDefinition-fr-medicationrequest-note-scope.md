# Scope for note element in MedicationRequest - Guide d'implémentation de la ePrescription v1.1.0-ballot
...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fhir.fr.eprescription|current/StructureDefinition/fr-medicationrequest-note-scope)
...
Extension simple avec le type code : Scope of a note associated in a MedicationRequest resource
...
Autres représentations du profil : [CSV](../StructureDefinition-fr-medicationrequest-note-scope.csv), [Excel](../StructureDefinition-fr-medicationrequest-note-scope.xlsx), [Schematron](../StructureDefinition-fr-medicationrequest-note-scope.sch) 
