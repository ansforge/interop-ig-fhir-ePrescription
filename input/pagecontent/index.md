...
<li>Accédez à la <a href="prescription-VueEnsemble.html">vue d'ensemble technique</a> pour l'architecture FHIR et aux <a href="prescription-Modelisation.html">règles de modélisation</a> pour les règles d'implémentation détaillées</li>
