...
<li>Consultez les <a href="prescription-Modelisation.html">Règles de modélisation</a> pour les règles d'implémentation détaillées (posologie, dates, perfusions, patchs...)</li>
...
- [Règles de modélisation](prescription-Modelisation.html) : règles d'implémentation détaillées (parties textuelles, terminologies, dates et durée, perfusions, patchs, dose calculée, liens entre lignes)
