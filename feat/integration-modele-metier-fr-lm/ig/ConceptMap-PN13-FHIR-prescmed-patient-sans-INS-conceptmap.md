# Conversion PN13 vers FHIR pour un patient sans INS qualifiée d'une prescription de médicaments - Guide d'implémentation de la ePrescription v1.1.0-ballot
...
| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/fhir/eprescription/ConceptMap/PN13-FHIR-prescmed-patient-sans-INS-conceptmap | *Version*:1.1.0-ballot |
| Draft as of 2026-09-25 | *Computable Name*:FrPN13FHIRMedicationPrescriptionPatientSansINSConceptMap |
