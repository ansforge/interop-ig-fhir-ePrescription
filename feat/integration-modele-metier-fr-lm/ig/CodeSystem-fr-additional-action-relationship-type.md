...
| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/fhir/eprescription/CodeSystem/fr-additional-action-relationship-type | *Version*:1.1.0-ballot |
| Draft as of 2026-09-25 | *Computable Name*:FrAdditionalActionRelationshipType |
...
* [Interop'Santé value set - Additional codes for relationship between action](ValueSet-fr-additional-action-relationship-type-value-set.md)
