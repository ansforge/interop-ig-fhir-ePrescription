# code system Interop'Santé - Codes pour typer le rôle des UF par rapport à un séjour patient - Guide d'implémentation de la ePrescription v0.1.0
...
| Draft as of 2026-05-04 | *Computable Name*:FrUFRoleCodes |
