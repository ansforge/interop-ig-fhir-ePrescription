...
* Accédez à la [vue d'ensemble technique](prescription-VueEnsemble.md) pour l'architecture FHIR et aux [règles de modélisation](prescription-Modelisation.md) pour les règles d'implémentation détaillées
